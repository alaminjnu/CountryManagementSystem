<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CountryViewUI.aspx.cs" Inherits="FinalProject.UI.CountryViewUI" EnableEventValidation="false" ValidateRequest="false" %>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-menubuilder">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li><a class="page-scroll" href="#">City SetUp</a> </li>
                        <li><a class="page-scroll" href="CountryViewUI.aspx">View Countries</a> </li>
                        <li><a class="page-scroll" href="#">View Cities</a> </li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <asp:GridView ID="countryGridView" runat="server" AutoGenerateColumns="False" CssClass="display">
                ...
                <Columns>
                    <asp:TemplateField HeaderText="No of Cities">
                        <ItemTemplate><%#Eval("CitiesNo") %></ItemTemplate>
                    </asp:TemplateField>
                </Columns>

                <Columns>
                    <asp:TemplateField HeaderText="No of Dwellers">
                        <ItemTemplate><%#Eval("DwellersNo") %></ItemTemplate>
                    </asp:TemplateField>
                </Columns>
